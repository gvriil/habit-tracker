...
class Habit(models.Model):
    ...
    reward = models.CharField(
        _("Вознаграждение"), max_length=255, null=True, blank=True
    )
...
class HabitCompletion(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="habit_completions"
    )
    completed_at = models.DateTimeField(_("Время выполнения"), default=timezone.now)
