...
class User(AbstractUser):
    ...
    telegram_id = models.CharField(
        _("ID в Telegram"), max_length=50, blank=True, null=True
    )
    telegram_username = models.CharField(
        _("Username в Telegram"), max_length=100, blank=True, null=True
    )
